...
class DataForGenerators:

    first_name_list = ['Иван', 'Олег', 'Анна', 'Петр', 'Диана', 'Василий', 'Виктория', 'Сергей', 'Павел', 'Елена',
                       'Дмитрий',
                       'Михаил']

    last_name_list = ['Иванов', 'Петров', 'Сидоров', 'Смирнов', 'Васильев', 'Котов', 'Степанов']

    address_list = ['Петровская ул, 2', 'Новочеркасский пр, 36', 'Республиканская ул. 23к1 ', 'Центральная 26',
                    'Красная прощадь', 'Дворцовая площадь', 'Одесская, 2', ' ']
    metro_station = ['Бульвар Рокоссовского', 'Лихоборы', 'Кузьминки']

    comment_list = ['нужен сегодня', 'срочно', 'сам хочу забрать', '-', 'а может есть другие цвета?']

    delivery_date = ['29.11.2024', '30.11.2024', '01.12.2024']

    rental_period = ['cутки', 'двое суток', 'трое суток', 'четверо суток', 'пятеро суток', 'шестеро суток', 'семеро суток']

    scooter_color = ['чёрный жемчуг', 'серая безысходность']